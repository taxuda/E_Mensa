...
<!--
- Praktikum DBWT. Autoren:
- Serdar, Akcay, 3235196
- Xuan Dat, Tran, 3255934
-->
<html lang="de">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    <div class="grid-container">
        ...
        <div class="r3"></div>
        <div class="r4">
          <?php //include 'carosel_diashow.php'; ?>
...
"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
            ...
            <!-- Table der Gerichten -->
            <!-- List of Allergen -->
            <?php include 'gericht_und_allergen.php'; ?>

            <!-- add eMensa in Zahlen als count.php-->
          ...
          <ul class="center-ul">
            ...
            <!-- add wunschgericht-link-->
            <h1 style="text-align: center; padding-bottom: 20px"><a href="formular/wunschgericht.php" target="_blank">Wunschgericht hier eintragen!</a></h1>
